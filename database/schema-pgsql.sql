...
CREATE TABLE FEATURE(
    FEATUREID   INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1000),
...
CREATE TABLE MTFCC(
        MTFCCID       INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1000),
        MTFCCCODE     CHAR(5),
        FEATURECLASS  VARCHAR(100),
...
CREATE TABLE LOCATION(
  LOCATIONID  INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1000),
  GEOID VARCHAR(7),
  STATEFP VARCHAR(2),
  COUNTYFP VARCHAR(3),
  TRACTFP VARCHAR(6),
...
CREATE TABLE BORDERPOINT(
    BORDERID  BIGINT GENERATED BY DEFAULT AS IDENTITY(START WITH 1000),
    LOCATIONID  INTEGER,
  LAT NUMERIC(14,5),
  LNG NUMERIC(14,5),
